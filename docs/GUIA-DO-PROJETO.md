...
2. ~~`FinancialDashboard.tsx` mockado sem aviso~~ — **ligado à API real em 19/08/2026** (ver linha "Frontend saindo do localStorage" acima). `OperatorCRM.tsx` continua 100% mock (só banner de aviso, sem API real) — esse gap segue aberto.
