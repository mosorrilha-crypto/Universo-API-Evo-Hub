...
// TASK-0308: a rota lê via getRuntimeKnowledgeBase — delega pra
// getKnowledgeBase() acima (nome mantido só como helper local; a store real
// não exporta mais getKnowledgeBase desde TASK-0327), então mockResolvedValueOnce
// por teste (se houver) continua valendo sem precisar duplicar em cada caso.
