...
export function KnowledgeBaseTypedDocumentsPanel({ activeTenantId }: { activeTenantId: string }) {
      ...
      <header className="flex flex-col gap-3 border-b border-slate-800 px-4 py-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex min-w-0 gap-3">
          ...
          <div>
            ...
            <p className="mt-1 max-w-3xl text-[11px] leading-5 text-slate-400">Organize a próxima versão por assunto, salve como rascunho e publique somente quando o conteúdo estiver revisado. O agente ainda continua usando a Base de Conhecimento legada nesta etapa.</p>
          </div>
        </div>
