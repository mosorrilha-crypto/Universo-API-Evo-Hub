...
export const LeadListRow: React.FC<LeadListRowProps> = ({
  ...
  return (
    ...
    >
      {/* Escala aumentada (pedido real, 01/09/2026, print comparando lado a
          lado com o WhatsApp Business real): avatar, nome, horário e prévia
        ...
        {/* Message Preview */}
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            {unreadCount > 0 ? (
              ...
              <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-emerald-950 text-emerald-300 border border-emerald-800/60 flex-shrink-0">
