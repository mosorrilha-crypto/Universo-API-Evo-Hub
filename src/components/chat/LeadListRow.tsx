  ...
  return (
    ...
    >
      <div className="relative flex-shrink-0">
        <div
          className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-[11px] border border-slate-700 ${avatarColorClasses(lead.name || lead.phone)}`}
        >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between">
          <h4 className="text-[11px] font-bold text-[#e9edef] truncate flex items-center gap-1">
        ...
        {/* Message Preview */}
          ...
          <p className={`text-[10px] truncate flex items-center pr-2 ${isUnread ? 'text-[#e9edef] font-semibold' : 'text-slate-400'}`}>
            {lastMsg ? (
              <>
